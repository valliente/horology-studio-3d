...
export const TopHeader: React.FC<TopHeaderProps> = ({
  ...
  return (
    <header className="w-full bg-[#14161D] border-b border-ent-border px-5 py-3 flex flex-wrap items-center justify-between gap-4 select-none z-20 shrink-0">
      {/* Profile Selector & Audio Monitor */}
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 bg-[#0D0E12] px-3.5 py-1.5 rounded-xl border border-ent-border">
          <Mic className="w-4 h-4 text-ent-cyan" />
          <span className="text-xs font-bold text-ent-muted">PROFILE:</span>
          <select
          ...
          >
            {profiles.map((p) => (
              <option key={p.id} value={p.id} className="bg-[#14161D] text-white">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-bold border transition-all ${
            monitorAudio
              ...
              : 'bg-[#0D0E12] border-ent-border text-ent-muted hover:text-white'
          }`}
        >
      ...
      <div className="flex items-center gap-3">
        ...
        {isRunning && (
          <button
            onClick={onStop}
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold bg-ent-red/20 border border-ent-red text-ent-red hover:bg-ent-red hover:text-white transition-all"
          >
      ...
      {/* Status Badge & Blue PRO Badge */}
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 text-xs bg-[#0D0E12] px-3 py-1.5 rounded-xl border border-ent-border">
        ...
        <span className="px-2.5 py-1 rounded-lg text-xs font-black bg-ent-blue text-white shadow-blue-glow tracking-widest uppercase">
          PRO
        </span>
      </div>
    </header>
